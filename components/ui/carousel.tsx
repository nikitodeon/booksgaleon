...
interface CarouselArrowProps {
  small?: boolean; // Добавляем пропс для управления размером
}
...
const CarouselPrevious = React.forwardRef<
  HTMLButtonElement,
  CarouselArrowProps & React.ComponentProps<typeof Button>
>(
  (
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute   rounded-full  bg-transparent  border-none hover:bg-[#B099D3]",
          small ? "h-5 w-5" : "h-7 w-7 lg:h-8 lg:w-8",
          orientation === "horizontal"
  ...
  (
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute border-none rounded-full hover:bg-[#B099D3]  bg-transparent",
          small ? "h-5 w-5" : "h-7 w-7 lg:h-8 lg:w-8 ",
          orientation === "horizontal"
